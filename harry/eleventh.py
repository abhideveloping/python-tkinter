...
can_widget.create_line(0, 200, 800, 400, fill="red")
can_widget.create_line(0, 400, 800, 0, fill="red")


#To create a rectangle specify parameters in this order - coordinates of top left and coords of bottom right
